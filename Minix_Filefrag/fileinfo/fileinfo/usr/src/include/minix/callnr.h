...
/* Calls provided by Mailbox */
#define OPENMAILBOX	108
#define	CLOSEMAILBOX	109
#define DEPOSITMESSAGE	110
#define RETRIEVEMESSAGE	105
#define GETRECEIVERLIST	103

/* Calls provided for fileinfo */
#define FILEINFO	69
#define BLOCKINFO	70
