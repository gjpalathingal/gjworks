...
/* Error codes for Mailbox */
#define EMSGEMPTY	    (_SIGN 91) /* empty message */
#define EINVALIDSENDER	(_SIGN 92)
#define EMAILBOXFULL	(_SIGN 93)
#define EMAILBOXNOTFOUND    (_SIGN 94)
