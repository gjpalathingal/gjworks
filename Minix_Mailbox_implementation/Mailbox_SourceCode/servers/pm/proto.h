...
/* mailbox.c */
_PROTOTYPE( int do_openMailbox, (void)					);
_PROTOTYPE( int do_closeMailbox, (void)					);
_PROTOTYPE( int do_depositMessage, (void)				);
_PROTOTYPE( int do_retrieveMessage, (void)				);
_PROTOTYPE( int do_getReceiverList, (void)				);
